...
class _RegisrationFormPageState extends State<RegisrationFormPage> {
  ...
  final _emailTextFormFieldValidationKey = GlobalKey<FormFieldState>();
    ...
    void saveAndNext({required String fname, required String mname, required String lname, required String parentName, required String email, required String mobile, required String birthDate, required String address, required XFile? profileUrl}) async{
      if(
        fname != "" &&
        mname != "" &&
        lname != "" &&
                ...
                Container(
                  ...
                  child: Row(
                    children: [
                      ...
                      Text("Personal Details", style: TextStyle(fontSize: screenHeight * app_heights.height28, color: Colors.white, fontWeight: FontWeight.bold),)
                    ],
                  ),
                ),
